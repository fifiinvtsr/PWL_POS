...
// Praktikum 2 Jobsheet 6
// Menampilkan data user dalam bentuk json untuk AJAX
...
// Menyimpan perubahan data user dalam bentuk json untuk AJAX
public function update_ajax(Request $request, $id)
{
    ...
    //Praktikum 3 Jobsheet 6
    //Membuat fungsi confirm ajax
    ...
    // Membuat fungsi delete ajax untuk mengakomodir request hapus data user
